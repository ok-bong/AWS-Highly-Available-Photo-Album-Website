...
define('STUDENT_NAME', 'Minh Phuong (Jade) Hoang');
// [ACTION REQUIRED] your Student ID
define('STUDENT_ID', '103795587');
// [ACTION REQUIRED] your tutorial session
define('TUTORIAL_SESSION', 'Tuesday 6:30PM');

// [ACTION REQUIRED] name of the S3 bucket that stores images
define('BUCKET_NAME', 'jade-photos');
...
define('DB_ENDPOINT', 'rdsinstance.cnj8zh7wq1ii.us-east-1.rds.amazonaws.com');
